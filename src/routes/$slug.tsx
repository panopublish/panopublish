          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              ...
              {page.type === "comparison" ? (
                <Link to="/pricing/">
                  <Button variant="outline" size="lg" className="border-slate-800 text-white hover:bg-slate-900 font-semibold px-6">
                    See PanoPublish Pricing
                  </Button>
                </Link>
              ) : (
                <a
                    ...
                    >
                      <div className="overflow-hidden">
                        <p className="text-muted-foreground text-xs md:text-sm leading-relaxed pb-4 pr-4">
                          {parseInlineFormatting(faq.answer)}
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              {page.type === "comparison" && (
                <Link to="/pricing/">
                  <Button
                    size="lg"
                    variant="outline"
                    className="border-white/40 text-white hover:bg-white/10 h-12 px-8 font-bold transition-transform hover:scale-105"
                  >
                    See PanoPublish Pricing
                  </Button>
                </Link>
