...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact PanoPublish — Support, Sales & Enterprise Enquiries" },
      {
        name: "description",
        content:
          "Get in touch with the PanoPublish team for support, questions about 360° virtual tour publishing, or custom enterprise solutions.",
      },
    ],
  }),
  component: ContactUs,
...
function ContactUs() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col font-sans antialiased text-foreground">
      <SEO
        title="Contact PanoPublish — Support, Sales & Enterprise Enquiries"
        description="Get in touch with the PanoPublish team for support, questions about 360° virtual tour publishing, or custom enterprise solutions."
