...
export const seoPages: Record<string, SeoPageData> = {
  "google-street-view-publishing": {
    ...
    "description": "Publish 360° virtual tours directly to Google Street View using PanoPublish. Flat monthly INR plans from ₹499, zero per-upload fees, auto-linked paths, and UPI payment support. Start free.",
  ...
  "360-virtual-tour-publishing-platform": {
    ...
    "description": "Create, host, and publish interactive 360 virtual tours with PanoPublish. Multi-client workspaces, fast WebGL viewer, direct Google Maps sync — flat ₹499/mo INR billing, no forex fees. Try free.",
  ...
  "panoee-alternative": {
    ...
    "type": "comparison",
    "title": "Panoee Alternative 2026: PanoPublish at ₹499/mo vs Panoee $18/mo",
  ...
  "tourbuilder-alternative-india": {
    ...
    "type": "comparison",
    "title": "TourBuilder Alternative India 2026: Flat \u20b9499/mo, Unlimited Google Street View Uploads",
    "description": "Compare TourBuilder vs PanoPublish for Indian photographers. \u20b9499/mo flat INR billing via UPI, unlimited Google Street View uploads (no per-export fee), and WhatsApp support in IST. Switch today.",
  ...
  "gothru-alternative": {
    ...
    "description": "Compare GoThru vs PanoPublish for Indian virtual tour creators. Zero USD billing markups, flat ₹499/mo via UPI or Razorpay, direct Google Maps sync, and agency white-labelling. Try 7 days free.",
  ...
  "matterport-alternative": {
    ...
    "type": "comparison",
    "title": "Matterport Alternative India 2026: Save \u20b91,250 Per Export, Flat \u20b9499/mo, UPI Payments",
    "description": "Compare Matterport vs PanoPublish. Stop paying $14.99 (\u2248\u20b91,250) per Street View export. PanoPublish: flat \u20b9499/mo INR billing, unlimited uploads, UPI payments, any-camera support. Start free.",
